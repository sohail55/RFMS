            ...
            <table class="table table-centered table-nowrap mb-0 rounded" id="myTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="#" class="text-primary fw-bold">Edit</a> <a href="#" class="text-primary fw-bold">Delete</a>  </td>
                    </tr>
                    @endforeach
                    <!-- End of Item -->
                </tbody>
          ...
          <div class="modal-content">
              <div class="modal-body p-0">
                  <div class="card p-3 p-lg-4">
                      ...
                      <form action="#" class="mt-4" name="subroles">
                          <!-- Form -->
                          <div class="form-group mb-4">
                              <label for="email">Role</label>
                              <div class="input-group">
                                  <select class="form-select" id="" name="role" required="required" >
