      ...
      <div class="py-4">
        ...
        <div class="d-flex justify-content-between w-100 flex-wrap">
            <div class="mb-3 mb-lg-0">
                <h1 class="h4">Resolved Complaints</h1>
            </div>
            <!-- <div>
                    ...
                    <tr>
                    	<td><a href="#" class="text-primary fw-bold"> 1</a> </td>
                      	...
                      	<td class="fw-bold ">Muhammad Shahzad  </td>
                     	  ...
                     	  <td class="fw-bold "> Resolved </td>
                      	<td class="fw-bold "> Farhan Riaz </td>
                      	<td class="fw-bold "><textarea id="comment" name="comment"></textarea> </td>
                        <td class="fw-bold "> <button class="btn btn-primary">Close</button>  </td>
                    </tr>
                    <tr>
