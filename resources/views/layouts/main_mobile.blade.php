...
<html class="no-js" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ asset('public/css/app-green.css') }}">
  ...
  <div class="app" id="app">
              ...
              <div class="col-md-4">
                  <div class="card tasks sameheight-item" data-exclude="xs,sm">
                      <div class="card-header bordered">
                          ...
                          <div class="header-block pull-right">
                              <a href="" class="btn btn-primary btn-sm rounded pull-right">
                                  Add new
                              </a>
                          </div>
                      </div>
                                          ...
                                          <div class="item-row">
                                              <div class="item-col item-col-title">
                                                  <label>
                                                      <input class="checkbox" type="checkbox"
                                                      checked="checked"> 
                                                      <span>Cheating with neighbours wifey</span>
                                                  </label>
                                              </div>
                                              <div class="item-col fixed item-col-actions-dropdown">
                                                  <div class="item-actions-dropdown">
    ...
    </div><!-- /.modal --><div class="modal fade" id="confirm-modal">
